...
public:
    TreeNode *buildTree(vector<int>& preorder,int prestart, int preend,
        ...
        root->left = buildTree(preorder,prestart+1, prestart+left, inorder, instart, rootidx-1,mp);
        root->right = buildTree(preorder,prestart+left+1, preend, inorder, rootidx+1, inend,mp);
        return root;
    }
